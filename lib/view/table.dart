...
class MyScrollableTableView extends StatefulWidget {
  const MyScrollableTableView({Key? key}) : super(key: key);

  @override
  State<MyScrollableTableView> createState() => _MyScrollableTableViewState();
}
...
class _MyScrollableTableViewState extends State<MyScrollableTableView> {
...
/* class MyScrollableTableView extends StatelessWidget {
  const MyScrollableTableView({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("ScrollTabView"),
      ),
      body: Container(
          ...
          child: Column(
            children: [
              TableFiveColumnReusableNew(
                ...
                entredField3: "Sub Division".tr(),
                entredField4: "Extent".tr(),
